...
namespace FlavorFare.API.Services.Authentication
{
    public class JwtTokenService : IJwtTokenService
    {
        ...
        public JwtTokenService(IConfiguration configuration, IRepository<RefreshToken> refreshTokenRepository, IRepository<FlavorFareUser> userRepository)
        {
        ...
        public async Task<(string AccessToken, string RefreshToken)?> RefreshTokensAsync(UserManager<FlavorFareUser> userManager, string refreshToken)
        {
